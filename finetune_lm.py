...
from lm_utils import TSVDataset, CLS_TOKEN, SEP_TOKEN, EOS_TOKEN
# EXP_TOKEN, EOS_TOKEN
...
def sample_sequence(model, length, context, device='cpu', sep_token_id=None):
    ...
    with torch.no_grad():
        for i in range(length):
            ...
            inputs = {'input_ids': generated, "return_dict": False}
